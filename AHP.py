...
# ============================================================
# 1. КОНФИГУРАЦИЯ ЗАДАЧИ (Данные из Слайдов 10 и 12)
# ============================================================
...
# Матрица парных сравнений КРИТЕРИЕВ (Слайд 10)
...
# Матрицы парных сравнений АЛЬТЕРНАТИВ по каждому критерию (Слайд 12)
ALT_MATRICES = {
